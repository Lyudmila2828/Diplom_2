...
class TestMakeOrder:
    ...
    def test_make_order_with_auth(self, test_user):
    ...
    def test_make_order_with_ingredients(self, ingredients, test_user):
        StellarBurgersAPI.register_user(test_user)
        accessToken = (
            StellarBurgersAPI.login_user(test_user["email"], test_user["password"])
            .json()
    ...
    def test_make_order_without_ingredients(self, test_user):
        StellarBurgersAPI.register_user(test_user)
        accessToken = (
            StellarBurgersAPI.login_user(test_user["email"], test_user["password"])
            .json()
    ...
    def test_make_order_with_invalid_ingredient_hash(self, test_user):
        StellarBurgersAPI.register_user(test_user)
        accessToken = (
            StellarBurgersAPI.login_user(test_user["email"], test_user["password"])
            .json()
